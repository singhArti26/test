...
#############################################################################################################
@RegressionDirectInvestmentSaleProcessAuto @RegressionDISScenario5AUTO @RegressionFinal
Feature: Verify that client services team initiates the case by choosing "Draft" for the fund "Ogilvie Midas LLC" - CS L2 reviews & accepts sale agreement and details - Client uploads final document - CS L1 reviews case and case goes till "Resolved" status
  ...
  Scenario Outline: CS L1 initiates the case - performs L1 sale of investment review - submits the case
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Draft         | testing    | ATOgilvie Midas LLC | Glaswegian Slone Inc. | \\DirectInvestmentResources\\sample.docx | Draft          | Transaction name |          15000 | Amortization: Administration Fees |   15000 | L1 - Sale of Inv. Initiation | L1 Sale Of Investment Review | Client Services 002 AT | Aire Irvine (Units) |

  @Direct_inv_sale_Draft_002
  ...
  Scenario Outline: CS L1 picks the case submitted CS L2 for "L1 cash col and recon" - submits case
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Executed      | testing    | L1 Cash Collection And Reconciliation | testing    | Client Services 002 AT |

  @Direct_inv_sale_Draft_004
  Scenario Outline: CS L2 picks the case submitted CS L1 for "L2 – Cash Col. and Recon. Review" - Resolves the case
    ...
    Examples: 
      | Username                           | Password    | Document_form | Intl_cmnts | Action_name                                  | Intl_cmnts | Action_By              |
      | ATClientservices001@alterdomus.com | Welcome@123 | Executed      | testing    | L2 Cash Collection And Reconciliation Review | testing    | Client Services 001 AT |

  @Direct_inv_sale_Draft_005
  Scenario Outline: Client picks the case submitted by CS L2 --> upload new sale agreement --> submits case
    ...
    Examples: 
      ...
      | ATClient001@alterdomus.com | Welcome@123 | Invoice 2           | testing    | \\DirectInvestmentResources\\sample.docx | Executed      | Upload Final Executed Investment Documents | testing    | Client001_AT |

  @Direct_inv_sale_Draft_006
  Scenario Outline: CS L1 picks the case submitted CS L2 for "L1 cash col and recon" - submits case
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Executed      | testing    |
