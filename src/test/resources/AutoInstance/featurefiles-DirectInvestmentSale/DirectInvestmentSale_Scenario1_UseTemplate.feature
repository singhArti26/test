...
#############################################################################################################
@RegressionDirectInvestmentSaleProcessAuto @RegressionDISScenario1AUTO @RegressionFinal
Feature: Verify that client services team initiates the case for any random fund by using "Use template" - CS L2 reviews & rejects sale agreement and details
  ...
  Scenario Outline: CS L1 initiates the case - performs L1 sale of investment review - submits the case
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Executed      | testing    | \\DirectInvestmentResources\\sample.docx | Draft          | Approve          | Transaction name |          15000 | Amortization: Administration Fees |   15000 | L1 - Sale of Inv. Initiation | L1 Sale Of Investment Review | Client Services 002 AT |

  @Direct_inv_sale_UseTemp_002
  Scenario Outline: CS L2 picks the case submitted by CS L1 - performs L2 sale of investment review - rejects the case
    ...
    Examples: 
      ...
      | ATClientservices001@alterdomus.com | Welcome@123 | testing    | L2 Sale of Investment Review | Client Services 001 AT |
