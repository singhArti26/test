...
#############################################################################################################
@RegressionDirectInvestmentSaleProcessAuto @RegressionDISScenario6AUTO @RegressionFinal
Feature: Verify that client services team initiates the case for the fund "Rickwood Handbook Co" - CS L2 transfers the case to another operator - CS 003 reviews & approves sale agreement and details - later case goes till "Resolved-completed" status
  ...
  Scenario Outline: CS L1 initiates the case - performs L1 sale of investment review - submits the case
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Executed      | testing    | ATRickwood Handbook Co. | Journal Greenworld LLC | \\DirectInvestmentResources\\sample.docx | Approve         | Transaction name |           5000 | Amortization: Administration Fees |    5000 | L1 - Sale of Inv. Initiation | L1 Sale Of Investment Review | Client Services 002 AT | Aire Irvine (Units) |

  @Direct_inv_sale_Trnsfr_002
  Scenario Outline: CS L2 picks the case submitted by CS L1 - Transfers case to CS 003
    ...
    Examples: 
      ...
      | ATClientservices001@alterdomus.com | Welcome@123 | testing    | L2 Sale of Investment Review | testing    | Client Services 001 AT | ATClientServices003@alterdomus.com | Transfer Assignment |

  @Direct_inv_sale_Trnsfr_003
  Scenario Outline: CS 003 picks the case submitted by CS L2 - performs L2 sale of investment review - approves the case
    ...
    Examples: 
      ...
      | ATClientServices003@alterdomus.com | Welcome@123 | testing    | L2 Sale of Investment Review | testing    | Client Services 003 AT |

  @Direct_inv_sale_Trnsfr_004
  ...
  Scenario Outline: CS L2 picks the case submitted CS L1 for "L2 – Cash Col. and Recon. Review" - Resolves the case
    ...
    Examples: 
      | Username                           | Password    | Document_form | Intl_cmnts | Confirm_decision | Action_name                                  | Intl_cmnts | Action_By              |
      | ATClientservices003@alterdomus.com | Welcome@123 | Executed      | testing    | Approve          | L2 Cash Collection And Reconciliation Review | testing    | Client Services 003 AT |
