...
###############################################################################################################################################################################
@Reg_Areteans__AlterDomusCC @RegressionFinal1 @CapSce_3 @CapitalCall3_AutoIns
Feature: Validate that as a Client for Trust Tweed Co. for Review Intake-Reject and assign to Client Services L1 where AD in charge of preparation & sending as well as AD Central Ops IS in charge of Investor Registry
  ...
  @TrustTweedCo_Initiation_1 @Smoke103_Today_25 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" initiate a case with the "<Fund>" and other required fields
    ...
    Examples: 
      ...
      | ATClient001@alterdomus.com | Welcome@123 | Capital Activity | L1 - Capital Activity Enrichment | ATTrust Tweed Co. | AutoTesting |                 0.01 | 08-21-2023 | 08-28-2023 |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_2 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and "<status>" by ClientServices-L1
    ...
    Examples: 
      ...
      | ATClientservices012@alterdomus.com | Welcome@123 | L2 - Capital Activity Review |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_3 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>"  reject and submit the case and validate the "<status>" by ClientServices-L2
    ...
    Examples: 
      ...
      | ATClientservices011@alterdomus.com | Welcome@123 | Automation Reject | L1 - Capital Activity Review |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_4 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and "<status>" by ClientServices-L1
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      ...
      | ATClientservices012@alterdomus.com | Welcome@123 | Amortization: Insurance | Investor Contribution |    20000 | L2 - Capital Activity Review |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_5 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" approve the case and "<status>" by ClientServices-L2
    ...
    Examples: 
      | Username                           | Password    | status                           |
      | ATClientservices011@alterdomus.com | Welcome@123 | L1 - Allocation File Preparation |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_6 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and Validate the "<status>" by Client Services L1
    ...
    Examples: 
      ...
      | ATClientservices012@alterdomus.com | Welcome@123 | \\attachments\\allocationfiletemplateTrust.xlsx | L2 - Allocation File Review |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_7 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and Validate the "<status>" by Client Services L2
    ...
    Examples: 
      | Username                           | Password    | status                  |
      | ATClientservices011@alterdomus.com | Welcome@123 | L1 - Notice Preparation |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_8 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and Validate the "<status>" by by Client Services L1
    ...
    Examples: 
      ...
      | ATClientservices012@alterdomus.com | Welcome@123 | \\attachments\\document1.pdf | L2 - Notice Review |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_9 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and Validate the "<status>" by by Client Services L2
    ...
    Examples: 
      | Username                           | Password    | status                  |
      | ATClientservices011@alterdomus.com | Welcome@123 | Client – Package Review |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_010 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and Validate the "<status>" by client
    ...
    Examples: 
      | Username                   | Password    | status                   |
      | ATClient001@alterdomus.com | Welcome@123 | L2 - Notice Distribution |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_011 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and Validate the "<status>" by Client Services L2
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      | Username                           | Password    | status                   |
      | ATClientservices011@alterdomus.com | Welcome@123 | L1 - Cash Reconciliation |

  @Smoke103_Today_25 @TrustTweedCo_Initiation_012 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and Validate the "<status>" by Client Services L1
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      | Username                           | Password    | status                   |
      | ATClientservices012@alterdomus.com | Welcome@123 | L2 - Cash Reconciliation |

  @TrustTweedCo_Initiation_013 @Smoke103_Today_25 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and Validate the "<status>" by Client Services L2
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      | Username                           | Password    | status                   |
      | ATClientservices011@alterdomus.com | Welcome@123 | L2 - Cash Reconciliation |

  @TrustTweedCo_Initiation_014 @Smoke103_Today_25 @alterDomus_Regression_Suite_CP
  Scenario Outline: Verify that user "<Username>" submit the case and Validate the "<status>" by COIS L1
    ...
    Examples: 
      | Username                    | Password    | DocumentPath                 | status             |
      | ATCOIS-02-l1@alterdomus.com | Welcome@123 | \\attachments\\document1.pdf | Resolved-Completed |
