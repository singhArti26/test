...
#############################################################################################################
@RegressionFOFCapital @FOFCapitalBulk4 @RegressionFinal
Feature: Verify that CS L1 initiates the case, AD rejects the case, later accepts and resolves the case
  ...
  Scenario Outline: Verify that user "<Username>" initiate case for FOF Capital Call with required fields
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | FOF Capital Call | ATOgilvie Midas LLC | TATA             | \\DirectInvestmentResources\\Invoice.pdf | 15000 | USD      | ICICI 1         | Glaswegian Slone Inc. | Aire Irvine (Units) |         876567 |     6765 |         7658 | Asset: Inventory  |    5000 | Asset: Goodwill/Intangible |    5000 | Asset: Property and Equipment |    5000 | Testing    | Testing    | L1 Fund Of Fund Capital Call Enrichment | Client Services 002 AT |
  ...
  Scenario Outline: "<Username>" rejects the case
    ...
    Examples: 
      ...
      | ATClientservices001@alterdomus.com | Welcome@123 | Testing    | L2 FOF Capital Call Review | Client Services 001 AT | Testing      |
  ...
  Scenario Outline: "<Username>" checks the rejected case
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Testing    | L1 Fund Of Fund Capital Call Enrichment | Client Services 002 AT | Priority     |
  ...
  Scenario Outline: "<Username>" accepts the case
    ...
    Examples: 
      ...
      | ATClientservices001@alterdomus.com | Welcome@123 | Testing    | L2 FOF Capital Call Review | Client Services 001 AT |
  ...
  Scenario Outline: "<Username>" performs L1 Liquidity Review
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Testing    | L1 Liquidity Review | Client Services 002 AT | No                   | Leverage credit line |
  ...
  Scenario Outline: "<Username>" performs L1 Call back
    ...
    Examples: 
      ...
      | ATCOPP-01-l1@alterdomus.com | Welcome@123 | Supporting documents - Call back | template name | template bank | John           | 9/14/2023 10:52 PM  |        1234567890 | Testing    | L1 Call Back | CO PP 01 - L1 AT | FOF     |
  ...
  Scenario Outline: "<Username>" performs L2 Call back review
    ...
    Examples: 
      ...
      | ATCOPP-01-l2@alterdomus.com | Welcome@123 | Supporting documents - Call back | Testing    | L2 Call Back Review | CO PP 01 - L2 AT | FOF     |
  ...
  Scenario Outline: "<Username>" performs L1 Call back again as case rejected by CS L2
    ...
    Examples: 
      ...
      | ATCOPP-01-l1@alterdomus.com | Welcome@123 | Testing    | L1 Call Back | CO PP 01 - L1 AT | FOF     |
  ...
  Scenario Outline: "<Username>" performs L2 Call back review
    ...
    Examples: 
      | Username                    | Password    | Intl_cmnts | Action_name  | Action_By        |
      | ATCOPP-01-l2@alterdomus.com | Welcome@123 | Testing    | L1 Call Back | CO PP 01 - L1 AT |
  ...
  Scenario Outline: "<Username>" performs L1 - Notice Payment Processing activity
    ...
    Examples: 
      | Username                    | Password    | Intl_cmnts | Action_name                  | Action_By        |
      | ATCOPP-01-l1@alterdomus.com | Welcome@123 | Testing    | L1 Notice Payment Processing | CO PP 01 - L1 AT |
  ...
  Scenario Outline: "<Username>" performs L2 - Notice Payment Processing activity
    ...
    Examples: 
      | Username                    | Password    | Intl_cmnts | Action_name              | Action_By        |
      | ATCOPP-01-l2@alterdomus.com | Welcome@123 | Testing    | L2 Notice Payment Review | CO PP 01 - L2 AT |
  ...
  Scenario Outline: "<Username>" performs L2 - Notice Payment Processing activity
    ...
    Examples: 
      ...
      | ATCOPP-01-l2@alterdomus.com | Welcome@123 | Testing    |
  ...
  Scenario Outline: "<Username>" performs "L1 - Notice Pay. Cash Recon." activity
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | L1 Notice Payment Cash Reconciliation | Testing    | Client Services 002 AT |
  ...
  Scenario Outline: "<Username>" performs "L2 - Notice Pay. Recon. Review" activity
    ...
    Examples: 
      ...
      | ATClientservices001@alterdomus.com | Welcome@123 | Testing    | L2 Notice Payment Cash Reconciliation Review | Client Services 001 AT | Please select the accounting platform has been updated to reflect the payments |
