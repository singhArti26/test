...
Feature: Verify that CSL1 initiates the case - client services team involves in approving case later case gets resolved
  ...
  Scenario Outline: Verify that user "<Username>" initiate case for FOF Capital Call with required fields
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | FOF Capital Call | ATOgilvie Midas LLC | TATA             | \\DirectInvestmentResources\\Invoice.pdf | 15000 | USD      | ICICI 1         | Glaswegian Slone Inc. | Aire Irvine (Units) |         876567 |     6765 |         7658 | Asset: Inventory  |   15000 | Testing    | Testing    | L1 Fund Of Fund Capital Call Enrichment | Client Services 002 AT |

  @FOFCapital_Apprve_002_AT @FOFCapital_Reg_AT
  ...
  @FOFCapital_Apprve_003_AT @FOFCapital_Reg_AT
  Scenario Outline: "<Username>" performs L1 Liquidity Review
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Testing    | L1 Liquidity Review | Client Services 002 AT | Yes                  |

  @FOFCapital_Apprve_004_AT @FOFCapital_Reg_AT
  Scenario Outline: "<Username>" performs L1 Call back
    ...
    Examples: 
      | Username                    | Password    | Intl_cmnts | Action_name         | Action_By              |
      | ATCOPP-01-l1@alterdomus.com | Welcome@123 | Testing    | L1 Liquidity Review | Client Services 002 AT |

  @FOFCapital_Apprve_005_AT @FOFCapital_Reg_AT
  Scenario Outline: "<Username>" performs L2 Call back review
    ...
    Examples: 
      ...
      | ATCOPP-01-l2@alterdomus.com | Welcome@123 | Supporting documents - Call back | Testing    | L1 Liquidity Review | Client Services 002 AT |

  @FOFCapital_Apprve_006_AT @FOFCapital_Reg_AT
  ...
  @FOFCapital_Apprve_007_AT @FOFCapital_Reg_AT
  ...
  @FOFCapital_Apprve_008_AT @FOFCapital_Reg_AT
  ...
  @FOFCapital_Apprve_009_AT @FOFCapital_Reg_AT
  ...
  @FOFCapital_Apprve_010_AT @FOFCapital_Reg_1_AT
