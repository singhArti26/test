...
Feature: Verify that CS L1 initiates the case - CS L2 transfers case to another operator
  ...
  Scenario Outline: Verify that user "<Username>" initiate case for FOF Capital Call with required fields
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | FOF Capital Call | ATRickwood Handbook Co. | TATA             | \\DirectInvestmentResources\\Invoice.pdf | 15000 | USD      | ABC123          | Journal Greenworld LLC |         876567 | Asset: Inventory  |   15000 | Testing    | Testing    | L1 Fund Of Fund Capital Call Enrichment | Client Services 002 AT |

  @FOFCapital_Trnsfr_002
  Scenario Outline: "<Username>" transfers the case to another operator
    ...
    Examples: 
      ...
      | ATClientservices001@alterdomus.com | Welcome@123 | Testing    | L1 Fund Of Fund Capital Call Enrichment | Client Services 002 AT | ATClientServices003@alterdomus.com | Transfer Assignment |

  @FOFCapital_Trnsfr_003
  Scenario Outline: "<Username>" picks the case
    ...
    Examples: 
      ...
      | ATClientservices003@alterdomus.com | Welcome@123 | Testing    | L2 FOF Capital Call Review | Client Services 003 AT |
