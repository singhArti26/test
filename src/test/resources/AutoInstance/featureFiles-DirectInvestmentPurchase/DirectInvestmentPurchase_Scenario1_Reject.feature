...
#############################################################################################################
@RegressionDirectInvestmentPurchaseProcess @RegressionDIPScenario1_AUTO @RegressionFinal
Feature: Verify that client services team initiates the case for the fund "Ogilvie Midas LLC" - CS L2 rejects purchase agreement - later approves it and case goes till "Resolved" status
  ...
  Scenario Outline: CS L2 picks the case submitted by CS L1 - performs L2 investment review - rejects the case
    ...
    Examples: 
      ...
      | ATClientservices001@alterdomus.com | Welcome@123 | testing    | The case cannot be approved if purchase agreement is rejected | L2 - Investment Review | testing    | Client Services 001 AT |

  @Direct_inv_prchseRjct_003
  ...
  Scenario Outline: CS L1 picks the case submitted client - do necessary changes - submits the case
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Executed      | testing    | Approve          | L1 - Investment Details Preparation | testing    | Client Services 002 AT |

  @Direct_inv_prchseRjct_005
  Scenario Outline: CS L2 picks the case submitted CS L1 - approves sale Agreement & approves details - submits case
    ...
    Examples: 
      | Username                           | Password    | Document_form | Intl_cmnts | Confirm_decision | Action_name            | Intl_cmnts | Action_By              |
      | ATClientservices001@alterdomus.com | Welcome@123 | Executed      | testing    | Approve          | L2 - Investment Review | testing    | Client Services 001 AT |

  @Direct_inv_prchseRjct_006
  Scenario Outline: CS L1 picks the case submitted CS L2 for "L1 - Liquidity Check" - submits case
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Executed      | testing    | Approve          | L1 Liquidity Check | testing    | Client Services 002 AT | No                   | Leverage credit line |

  @Direct_inv_prchseRjct_007
  Scenario Outline: "<Username>" performs L1 - Call Back Preparation
    ...
    Examples: 
      ...
      | ATCOPP-01-l1@alterdomus.com | Welcome@123 | Supporting documents - Call back | template name | template bank | John           | 9/14/2023 10:52 PM  |        1234567890 | Testing    | Call Back   | CO PP 01 - L1 AT | DIP     |

  @Direct_inv_prchseRjct_008
  Scenario Outline: "<Username>" performs L2 Call back review
    ...
    Examples: 
      ...
      | ATCOPP-01-l2@alterdomus.com | Welcome@123 | Supporting documents - Call back | Testing    | L2 Call Back Review | CO PP 01 - L2 AT | DIP     |

  @Direct_inv_prchseRjct_009
  Scenario Outline: "<Username>" performs L1 - Call Back Preparation as case rejected by COPP L2
    ...
    Examples: 
      ...
      | ATCOPP-01-l1@alterdomus.com | Welcome@123 | Testing    | Call Back   | CO PP 01 - L1 AT | DIP     |

  @Direct_inv_prchseRjct_010
  Scenario Outline: "<Username>" performs L2 Call back review
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      ...
      | ATCOPP-01-l2@alterdomus.com | Welcome@123 | Testing    | Call Back   | CO PP 01 - L1 AT |

  @Direct_inv_prchseRjct_011
  Scenario Outline: "<Username>" performs L1 - Payment Preparation
    ...
    Examples: 
      | Username                    | Password    | Intl_cmnts | Action_name            | Action_By        |
      | ATCOPP-01-l1@alterdomus.com | Welcome@123 | Testing    | L1 Payment Preparation | CO PP 01 - L1 AT |

  @Direct_inv_prchseRjct_012
  Scenario Outline: "<Username>" performs L2 - Payment Review activity
    ...
    Examples: 
      | Username                    | Password    | Intl_cmnts | Action_name       | Action_By        |
      | ATCOPP-01-l2@alterdomus.com | Welcome@123 | Testing    | L2 Payment Review | CO PP 01 - L2 AT |

  @Direct_inv_prchseRjct_013
  Scenario Outline: "<Username>" performs L1 - Payment Preparation
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
  ...
  Scenario Outline: "<Username>" performs Payment Review
    ...
    Examples: 
      ...
      | ATClient001@alterdomus.com | Welcome@123 | Supporting documents - Payment release | Testing    | L2 Notice Payment Review | CO PP 01 - L2 AT |

  @Direct_inv_prchseRjct_016
  Scenario Outline: "<Username>" performs "L1 - Notice Pay. Cash Recon." activity
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | L1 Reconciliation | Testing    | Client Services 002 AT |

  @Direct_inv_prchseRjct_017
  Scenario Outline: "<Username>" performs "L2 - Notice Pay. Recon. Review" activity
    ...
    Examples: 
      ...
      | ATClientservices001@alterdomus.com | Welcome@123 | Testing    | L2 Reconciliation Review | Client Services 001 AT | **Please select accounting platform has been reviewed for investment |
