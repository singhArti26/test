...
#############################################################################################################
@RegressionDirectInvestmentPurchaseProcess @RegressionDIPScenario2AUTO @RegressionFinal
Feature: Verify that client services team initiates the case for the fund "Ogilvie Midas LLC" - CS L2 accepts purchase agreement - later approves it and case goes till "Resolved" status
  ...
  Scenario Outline: CS L1 initiates the case - performs L1 investment review - submits the case
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Executed      | testing    | ATOgilvie Midas LLC | Glaswegian Slone Inc. | \\DirectInvestmentResources\\sample.docx | Draft             | Approve          | Transaction name |            15000 | Amortization: Administration Fees |    5000 | Amortization: Insurance |    5000 | Cash: Received    |    5000 | L1 - Sale of Inv. Initiation | L1 - Investment Details Preparation | Client Services 002 AT | Direct Investment Purchase | Aire Irvine (Units) |

  @Direct_inv_prchseApprve_002
  ...
  Scenario Outline: CS L1 picks the case submitted CS L2 for "L1 - Liquidity Check" - submits case
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Executed      | testing    | Approve          | L1 Liquidity Check | testing    | Client Services 002 AT | Yes                  |

  @Direct_inv_prchseApprve_004
  Scenario Outline: "<Username>" performs L1 - Call Back Preparation as case rejected by COPP L2
    ...
    Examples: 
      ...
      | ATCOPP-01-l1@alterdomus.com | Welcome@123 | testing    | L1 Liquidity Check | Client Services 002 AT |

  @Direct_inv_prchseApprve_005
  Scenario Outline: "<Username>" performs L2 Call back review
    ...
    Examples: 
      | Username                    | Password    | Intl_cmnts | Action_name        | Action_By              |
      | ATCOPP-01-l2@alterdomus.com | Welcome@123 | testing    | L1 Liquidity Check | Client Services 002 AT |

  @Direct_inv_prchseApprve_006
  ...
  Scenario Outline: Client uploads final "Executed" document and send it for L1 document review
    ...
    Examples: 
      ...
      | ATClient001@alterdomus.com | Welcome@123 | Invoice 2           | testing    | \\DirectInvestmentResources\\sample.docx | Executed      | Upload Executed Documents | testing    | Client001_AT | Priority     |

  @Direct_inv_prchseApprve_012
  Scenario Outline: "<Username>" performs "L1 - Notice Pay. Cash Recon." activity
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | Client Services 002 AT | Approve          |
