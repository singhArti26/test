...
#############################################################################################################
@RegressionFOFcommitmentAUTO @FOFcommitmentBulkRun2AUTO @FOFCOmmint123 @Reg_Areteans__AlterDomusFOFC @RegressionFinal1
Feature: As a client service L1 with Fund Kemp Hickinbottom Co. with toggle as "No "for Is this a new Investment and user "Draft" for purchase Agreement with OutcomeOf Review as "Approve"
  ...
  Scenario Outline: Create a case in ClientServices-L1
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | FOF Commitment | ATKemp Hickinbottom Co. | Brunswick Less Co. |            10000 |        10000 | \\DirectInvestmentResources\\Invoice.pdf | test            | Aire Irvine (Units) |

  @FOFcommitment_Draft_002
  ...
  Scenario Outline: Upload Executed Documents in client login
    ...
    Examples: 
      | Username                   | Password    | upld_pdfFile                             |
      | ATClient001@alterdomus.com | Welcome@123 | \\DirectInvestmentResources\\Invoice.pdf |

  @FOFcommitment_Draft_006
