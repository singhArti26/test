...
#############################################################################################################
@RegressionFOFcommitmentAUTO @FOFcommitmentBulkRun1AUTO @Reg_Areteans__AlterDomusFOFC @RegressionFinal1
Feature: As a client operator with Fund RickWood HandbookCo.. with toggle as "Yes "for "Is this a new Investment and user "Executed" for purchase Agreement with OutcomeOf Review as "Approve"
  ...
  Scenario Outline: Create a case in Client
    ...
    Examples: 
      ...
      | ATClient001@alterdomus.com | Welcome@123 | FOF Commitment | testname      | USD      |          10000 | ATKemp Hickinbottom Co. | \\DirectInvestmentResources\\Invoice.pdf |

  @FOFcommitment_Scenario_002 @testFOFComm
  Scenario Outline: Create a case in ClientServices-L1
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | testName        |            1 |   10000 | John          | Convertible Loan |

  @FOFcommitment_Scenario_003
