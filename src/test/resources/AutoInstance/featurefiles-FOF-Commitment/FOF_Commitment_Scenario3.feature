...
#############################################################################################################
@RegressionFOFcommitmentAUTO @FOFcommitmentBulkRun3AUTO @FOFCOmmint123 @Reg_Areteans__AlterDomus @Reg_Areteans__AlterDomusFOFC @RegressionFinal1
Feature: As a client operator for Fund Rickwood Handbook Co.. with toggle as "Yes "for "Is this a new Investment and user marks "Executed" for purchase Agreement with banking details for this investment
  ...
  @FOFcommitment_Pymnt_Scenario_001
  Scenario Outline: Create a case in Client
    ...
    Examples: 
      ...
      | ATClient001@alterdomus.com | Welcome@123 | FOF Commitment | ATRickwood Handbook Co. | testname      |          10000 | \\DirectInvestmentResources\\Invoice.pdf |

  @FOFcommitment_Pymnt_Scenario_002
  Scenario Outline: Create a case in ClientServices-L1
    ...
    Examples: 
      ...
      | ATClientservices002@alterdomus.com | Welcome@123 | testname        | John          | Convertible Loan |   10000 |            1 | testBank |       12345 | Canada  |

  @FOFcommitment_Pymnt_Scenario_003
  ...
  @FOFcommitment_Pymnt_Scenario_004
  Scenario Outline: provide call back details in COPPL1
    ...
    Examples: 
      ...
      | ATCOPP-01-l1@alterdomus.com | Welcome@123 | John           | 9/20/2023 10:52 PM  |        1234567890 | testName      | tmplteBank    | FOF     | \\DirectInvestmentResources\\Invoice.pdf |

  @FOFcommitment_Pymnt_Scenario_005
  ...
  @FOFcommitment_Pymnt_Scenario_006
  ...
  @FOFcommitment_Pymnt_Scenario_007
