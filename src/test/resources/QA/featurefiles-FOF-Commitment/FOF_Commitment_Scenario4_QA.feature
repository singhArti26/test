...
#############################################################################################################
@RegressionFOFcommitment_QA @FOFcommitmentBulkRun4_QA @FOFCOmmint123_QA @Reg_Areteans__AlterDomus_QA @Reg_Areteans__AlterDomusFOFC_QA @RegressionRunQA
Feature: As a client service L1 with Fund Kemp Hickinbottom Co. with toggle as "No "for Is this a new Investment and user "Executed" for purchase Agreement with OutcomeOf Review as "Reject"
  ...
  Scenario Outline: Create a case in ClientServices-L1
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | FOF Commitment | ATKemp Hickinbottom Co. | Brunswick Less Co. |            10000 | \\DirectInvestmentResources\\Invoice.pdf | trnsctnName     |            1 | testBnk  |      123456 | Canada  |        10000 | Aire Irvine (Units) |
  ...
  Scenario Outline: Approve a case in ClientServices-L1
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | testing    |
  ...
  Scenario Outline: provide call back details in COPPL1
    ...
    Examples: 
      ...
      | COPP-01-l1@alterdomus.com | Welcome@123 | John           | 9/20/2023 10:52 PM  |        1234567890 | \\DirectInvestmentResources\\Invoice.pdf | tmplteName    | tmplteBank    | FOF     |
