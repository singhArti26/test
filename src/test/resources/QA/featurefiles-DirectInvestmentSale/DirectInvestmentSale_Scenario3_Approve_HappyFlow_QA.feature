...
#############################################################################################################
@RegressionDirectInvestmentSaleProcess_QA @RegressionDISScenario3_QA @RegressionFinal @RegressionRunQA
Feature: Verify that client services team initiates the case for the fund "<Fund>" - CS L2 reviews & approves sale agreement and details - later case goes till "Resolved" status
  ...
  Scenario Outline: CS L1 initiates the case - performs L1 sale of investment review - submits the case
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | Executed      | testing    | ATRickwood Handbook Co. | Journal Greenworld LLC | \\DirectInvestmentResources\\sample.docx | Approve         | Transaction name |           5000 | Amortization: Administration Fees |    5000 | L1 - Sale of Inv. Initiation | L1 Sale Of Investment Review | Client Services 002 |
  ...
  Scenario Outline: CS L1 picks the case submitted CS L2 for "L1 cash col and recon" - submits case
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | Executed      | testing    | Approve          | L1 Cash Collection And Reconciliation | testing    | Client Services 002 | Priority     |
