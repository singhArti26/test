...
###############################################################################################################################################################################
@Reg_Areteans__AlterDomusCC_QA @CapCall_1QA
Feature: Verify that Capital actvity process should be initiated by CSL1 and Resloved-completd by CSL2

  @alterDomus_Capital_call_Reg_123410_QA @alterDomus_Regression_Suite_CP_QA @testDate
  Scenario Outline: Verify that user "<Username>" initiate a case with the "<Fund>" and other required fields
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | Capital Activity | ATOgilvie Midas LLC | AutoTesing      |           30000 | L2 - Capital Activity Review |

  @alterDomus_Capital_call_Reg_123456_QA @alterDomus_Regression_Suite_CP_QA
  ...
  Scenario Outline: Verify that user "<Username>" validate the "<status>" by ClientServices-L1
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | L2 - Allocation File Review | \\attachments\\allocationfiletemplate30k.xlsx |
  ...
  @alterDomus_Capital_call_Reg_1234567_QA @alterDomus_Regression_Suite_CP_QA
