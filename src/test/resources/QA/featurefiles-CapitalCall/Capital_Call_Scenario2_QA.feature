...
####################################################################################################################################################################
@Reg_Areteans__AlterDomusCC_QA @CapCall_2QA
Feature: Verify that as a Client for Kemp Hickinbottom Co. for Review Intake-Reject and assign to Client where AD in charge of preparation and client in charge of sending as well as AD Central Ops IS in charge of Investor Registry
  ...
  Scenario Outline: Verify that user "<Username>" initiate a case with the "<Fund>" and other required fields
    ...
    Examples: 
      ...
      | Client001@alterdomus.com | Welcome@123 | Capital Activity | ATKemp Hickinbottom Co. | L1 - Capital Activity Enrichment |                 0.01 | Automation Testing |
  ...
  Scenario Outline: Verify that user "<Username>" submit case and "<status>" by ClientServices-L1
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | Amortization: Insurance |    30000 | Brunswick Less Co. | Andreas Nephew (Series Z) | L2 - Capital Activity Review |
  ...
  Scenario Outline: Verify that user "<Username>" reject the case and "<status>" by ClientServices-L2
    ...
    Examples: 
      ...
      | Clientservices001@alterdomus.com | Welcome@123 | Testing | Client - Cap Activity Initiation |
  ...
  Scenario Outline: Verify that user "<Username>" submit the case and "<status>" by client
    ...
    Examples: 
      ...
      | Client001@alterdomus.com | Welcome@123 | L1- Capital Activity Review |
  ...
  Scenario Outline: Verify that user "<Username>" submit case and "<status>" by ClientServices-L1
    ...
    Examples: 
      | Username                         | Password    | status                       |
      | Clientservices002@alterdomus.com | Welcome@123 | L2 - Capital Activity Review |
  ...
  Scenario Outline: Verify that user "<Username>" approve case and "<status>" by COIS L1.
    ...
    Examples: 
      ...
      | COIS-02-l1@alterdomus.com | Welcome@123 | \\attachments\\document1.pdf | L1 - Allocation File Preparation |
  ...
  Scenario Outline: Verify that user "<Username>" approve case and "<status>" by ClientServices-L1
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | \\attachments\\allocationfiletemplate_Kemp_Hickinbottom.xlsx | L2 - Allocation File Review |
  ...
  Scenario Outline: Verify that user "<Username>" approve case and "<status>" by Client
    ...
    Examples: 
      | Username                 | Password    | status                   |
      | Client001@alterdomus.com | Welcome@123 | L1 - Cash Reconciliation |
