...
###############################################################################################################################################################################
@Reg_Areteans__AlterDomusCC_QA @RegressionFinal1_QA @CapitalCall5_QA
Feature: Validate Capital activity process for fund Ogilvie Midas LLC with case level Rejection

  @Smoke105_Today_Done_QA @Capital_Call_ScenarioOutline5_1_QA @CapitalCall_Reg_1_QA @alterDomus_Regression_Suite_CP_QA @onlyThis
  Scenario Outline: Verify that user "<Username>" Create process id for the "<Fund>" and other required fields
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | Capital Activity | ATOgilvie Midas LLC |           22500 | L2 - Capital Activity Review |

  @Smoke105_Today_Done_QA @Capital_Call_ScenarioOutline5_1_QA @CapitalCall_Reg_1_QA @alterDomus_Regression_Suite_CP_QA
  Scenario Outline: Verify that user "<Username>" approve case and Validate the "<status>" by Client Services L2
    ...
    Examples: 
      ...
      | Clientservices001@alterdomus.com | Welcome@123 | L1 - Allocation File Preparation |

  @Smoke105_Today_Done_QA @Capital_Call_ScenarioOutline5_3_QA @CapitalCall_Reg_1_QA @alterDomus_Regression_Suite_CP_QA
  Scenario Outline: Verify that user "<Username>" submit case and Validate the "<status>" by Client Services L1
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | \\attachments\\allocationfiletemplate1.xlsx | L2 - Allocation File Review |
  ...
  Scenario Outline: Verify that user "<Username>" submit case and Validate the "<status>" by Client Services L2
    ...
    Examples: 
      | Username                         | Password    | status                  |
      | Clientservices001@alterdomus.com | Welcome@123 | L1 - Notice Preparation |
  ...
  Scenario Outline: Verify that user "<Username>" submit case and Validate the "<status>" by Client Services L1
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | \\attachments\\document2.pdf | L2 - Notice Review |
  ...
  Scenario Outline: Verify that user "<Username>" submit case and Validate the "<status>" by Client Services L2
    ...
    Examples: 
      | Username                         | Password    | status                  |
      | Clientservices001@alterdomus.com | Welcome@123 | Client – Package Review |
  ...
  Scenario Outline: Verify that user "<Username>" reject and submit the case and Validate the "<status>" by Client
    ...
    Examples: 
      | Username                 | Password    | status                  |
      | Client002@alterdomus.com | Welcome@123 | L1 - Notice Preparation |
  ...
  Scenario Outline: Verify that user "<Username>" upload the document again submit case and Validate the "<status>" by Client Services L1
    ...
    Examples: 
      | Username                         | Password    | DocumentPath                 | status             |
      | Clientservices002@alterdomus.com | Welcome@123 | \\attachments\\document1.pdf | L2 - Notice Review |
  ...
  Scenario Outline: Verify that user "<Username>" approve the allocation file for case and Validate the "<status>" by Client
    ...
    Examples: 
      | Username                 | Password    | status                   |
      | Client002@alterdomus.com | Welcome@123 | L1 - Cash Reconciliation |
  ...
  Scenario Outline: Verify that user "<Username>" submit case for Cash Reconciliation and Validate the "<status>" by Client Services L1
    ...
    Examples: 
      | Username                         | Password    | status                   |
      | Clientservices002@alterdomus.com | Welcome@123 | L2 - Cash Reconciliation |
