...
Feature: Verify that COIS L2 reject Document to COIS L1 and reject the case level
  ...
  Scenario Outline: Verify that user "<Username>" initiate a Transfer case for "<Fund>" and other required fields
    ...
    Examples: 
      ...
      | COIS-02-L1@alterdomus.com | Welcome@123 | Transfer    | Fathoms Artisan L.P. | Automation Testing | \\attachments\\document1.pdf | \\attachments\\document2.pdf | By COISL1        | By COISL1        | L2 - Initiation |

  @Tansfer_COISL1_initiate_7125_2_QA
  Scenario Outline: Verify that user "<Username>" approve the case and "<status>" by COISL1
    ...
    Examples: 
      ...
      | COIS-03-l2@alterdomus.com | Welcome@123 | Assign Priority | rejected the second doc | Testing          | L1 - Initiation |

  @Tansfer_COISL1_initiate_7125_3_QA
  Scenario Outline: Verify that user "<Username>" submit the case and "<status>" by client
    ...
    Examples: 
      ...
      | COIS-02-l1@alterdomus.com | Welcome@123 | rejected the second doc | Priority       | COISL1           | \\attachments\\document1.pdf | L2 - Initiation |

  @Tansfer_COISL1_initiate_7125_4_QA
  Scenario Outline: Verify that user "<Username>" approve the case and "<status>" by COIS-L2
    ...
    Examples: 
      ...
      | COIS-03-l2@alterdomus.com | Welcome@123 | By COISL2        | Case level rejection | L1 - Initiation        |

  @Tansfer_COISL1_initiate_7125_5_QA
  Scenario Outline: Verify that user "<Username>" submit the case and "<status>" by client
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      | Username                  | Password    | Rejectcomments       | prioritystatus | Internalcomments | DocumentPath                 | status          |
      | COIS-02-l1@alterdomus.com | Welcome@123 | Case level rejection | Priority       | COISL1           | \\attachments\\document1.pdf | L2 - Initiation |

  @Tansfer_COISL1_initiate_7125_6_QA
  Scenario Outline: Verify that user "<Username>" approve the case and "<status>" by COIS-L2
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      | Username                  | Password    | Internalcomments | Reason               | status                 |
      | COIS-03-l2@alterdomus.com | Welcome@123 | By COISL2        | Case level rejection | L1 - Accounting Checks |

  @Tansfer_COISL1_initiate_7125_7_QA
  Scenario Outline: Verify that user "<Username>" submit the case and "<status>" by ClientServices-L1
    ...
    Examples: 
      ...
      | Clientservices016@alterdomus.com | Welcome@123 | Transfer Assignment | By CSL1          | L2 - Accounting Checks |

  @Tansfer_COISL1_initiate_7125_8_QA
  Scenario Outline: Verify that user "<Username>" submit the case and "<status>" by ClientServices-L1
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      ...
      | Clientservices015@alterdomus.com | Welcome@123 | By CSL2          | L1 - Final Confirmations |

  @Tansfer_COISL1_initiate_7125_9_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by ClientServices-L2
    ...
    Examples: 
      | Username                         | Password    | Internalcomments | status                   |
      | Clientservices016@alterdomus.com | Welcome@123 | By CSL1          | L2 - Final Confirmations |

  @Tansfer_COISL1_initiate_7125_10_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by ClientServices-L2
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      | Username                         | Password    | Internalcomments | status             |
      | Clientservices015@alterdomus.com | Welcome@123 | By CSL2          | Resolved-Completed |
