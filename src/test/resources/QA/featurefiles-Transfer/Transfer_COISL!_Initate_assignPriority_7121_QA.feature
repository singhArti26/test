...
############################################################################################################
@Reg_Areteans__AlterDomusTT_QA @RegressionFinal1 @transferSecond_QA
Feature: Verify that COIS L2 reject the Document to send to client and Case level Reslove

  @Tansfer_COISL1_initiate_7121_1_QA @test_QA1
  Scenario Outline: Verify that user "<Username>" initiate a Transfer case for "<Fund>" and other required fields
    ...
    Examples: 
      ...
      | COIS-02-L1@alterdomus.com | Welcome@123 | Transfer    | Kemp Hickinbottom Co. | Automation Testing | \\attachments\\document1.pdf | \\attachments\\document2.pdf | By COISL1        | By COISL1        | L2 - Initiation |

  @Tansfer_COISL1_initiate_7121_2_QA @test_QA1
  Scenario Outline: Verify that user "<Username>" approve the case and "<status>"
    ...
    Examples: 
      ...
      | COIS-03-l2@alterdomus.com | Welcome@123 | Assign Priority | rejected the second doc | Client - Transfer Initiation |

  @Tansfer_COISL1_initiate_7121_3_QA
  Scenario Outline: Verify that user "<Username>" submit the case and "<status>"
    ...
    Examples: 
      ...
      | Client001@alterdomus.com | Welcome@123 | rejected the second doc | Priority       | \\attachments\\document1.pdf | L1 - Initiation |

  @Tansfer_COISL1_initiate_7121_4_QA
  Scenario Outline: Verify that user "<Username>" reject the case and "<status>"
    ...
    Examples: 
      | Username                  | Password    | Crossprocess        | Reason        | status          |
      | COIS-02-l1@alterdomus.com | Welcome@123 | Transfer Assignment | reject reason | L2 - Initiation |

  @Tansfer_COISL1_initiate_7121_5_QA
  Scenario Outline: Verify that user "<Username>" approve the case and "<status>"
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      ...
      | COIS-03-l2@alterdomus.com | Welcome@123 | L1 - AMLKYC Review |

  @Tansfer_COISL1_initiate_7121_6_QA @feature2_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>"
    ...
    Examples: 
      | Username                  | Password    | status                         |
      | COIS-02-l1@alterdomus.com | Welcome@123 | L2 - Inv Registry Confirmation |

  @Tansfer_COISL1_initiate_7121_7_QA @feature2_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>"
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      ...
      | COIS-03-l2@alterdomus.com | Welcome@123 | Transfer Assignment | \\attachments\\document1.pdf | Automation Testing | L2 - Inv Registry Confirmation |

  @Tansfer_COISL1_initiate_7121_8_QA @feature2_QA
  Scenario Outline: Verify that user "<Username>" submit the case and "<status>"
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      ...
      | Clientservices014@alterdomus.com | Welcome@123 | Transfer Assignment | By CSL1          | L2 - Accounting Checks |

  @Tansfer_COISL1_initiate_7121_9_QA @feature2_QA
  Scenario Outline: Verify that user "<Username>" submit the case and  "<status>"
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      ...
      | Clientservices013@alterdomus.com | Welcome@123 | By CSL2          | L1 - Final Confirmations |

  @Tansfer_COISL1_initiate_7121_10_QA @feature2_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>"
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      | Username                         | Password    | Internalcomments | status                   |
      | Clientservices014@alterdomus.com | Welcome@123 | By CSL1          | L2 - Final Confirmations |

  @Tansfer_COISL1_initiate_7121_11_QA @feature2_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by ClientServices-L2
    ...
    Examples: 
      | Username                         | Password    | Internalcomments | status             |
      | Clientservices013@alterdomus.com | Welcome@123 | By CSL2          | Resolved-Completed |
