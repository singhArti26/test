...
@Reg_Areteans__AlterDomusTT_QA @transferFirst_QA
Feature: Verify that as a client with fund "<Fund>" where AD is in charge of prepartion and client is in charge of Review and Release
  ...
  Scenario Outline: Verify that user "<Username>" initiate a Transfer case for "<Fund>" and other required fields
    ...
    Examples: 
      ...
      | Client001@alterdomus.com | Welcome@123 | Transfer    | Ogilvie Midas LLC | Automation Testing | \\attachments\\document1.pdf | L1 - Transfer Review | AutoTest          | Cancel Request |

  @Tansfer_Reject_002_QA
  Scenario Outline: Verify that user "<Username>" submit case and "<status>" by ClientServices-L1
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 |  8763245435535 | L2 - Transfer Review |

  @Tansfer_Reject_003_QA
  Scenario Outline: Verify that user "<Username>" approve the case and "<status>" by ClientServices-L2
    ...
    Examples: 
      ...
      | Clientservices001@alterdomus.com | Welcome@123 | Automation Test Reject | L2 - Transfer Review |

  @Tansfer_Reject_004_QA
  Scenario Outline: Verify that user "<Username>" assign Priority and Approve case by CSL2
    ...
    Examples: 
      ...
      | Clientservices001@alterdomus.com | Welcome@123 | Assign Priority | Reject the through automating | Client - Transfer Initiation |

  @Tansfer_Reject_005_QA
  Scenario Outline: Verify that user "<Username>" submit the case and "<status>" by client
    ...
    Examples: 
      ...
      | Client001@alterdomus.com | Welcome@123 | Reject the through automating | \\attachments\\document1.pdf | uploaded new doc | Client - Transfer Initiation |

  @Tansfer_Reject_006_QA
  Scenario Outline: Verify that user "<Username>" reject the case and "<status>" by ClientServices-L1
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | Transfer Assignment | L2 - Transfer Review |

  @Tansfer_Reject_007_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by ClientServices-L2
    ...
    Examples: 
      | Username                         | Password    | Crossprocess        | status                      |
      | Clientservices001@alterdomus.com | Welcome@123 | Transfer Assignment | L1 - AML/KYC Comfort Letter |

  #
  @Tansfer_Reject_008_QA
  Scenario Outline: Verify that user "<Username>" reject the case and "<status>" by ClientServices-L1
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      | Username                         | Password    | Crossprocess        | status                 |
      | Clientservices002@alterdomus.com | Welcome@123 | Transfer Assignment | L2 - Accounting Checks |

  @Tansfer_Reject_009_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by ClientServices-L2
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      | Username                         | Password    | Crossprocess        | status                 |
      | Clientservices001@alterdomus.com | Welcome@123 | Transfer Assignment | L2 - Accounting Checks |

  @Tansfer_Reject_010_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by ClientServices-L2
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
    ...
    Examples: 
      | Username                  | Password    | Crossprocess        | status                 |
      | COIS-02-l1@alterdomus.com | Welcome@123 | Transfer Assignment | L2 - Accounting Checks |
  ...
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by ClientServices-L2
    ...
    Examples: 
      | Username                         | Password    | status                   |
      | Clientservices002@alterdomus.com | Welcome@123 | L2 - Final Confirmations |
