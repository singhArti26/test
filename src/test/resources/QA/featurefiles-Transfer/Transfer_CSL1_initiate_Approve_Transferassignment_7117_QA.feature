...
#TRA-51005
#############################################################################################################
@Reg_Areteans__AlterDomusTT_QA @transfer4_QA
Feature: Verify that as a COIS create a process using the Use template and Transfer the case to next level cross funcnality
  ...
  @Tansfer_CSL1_initiate_7117 @Reg_7117_1_QA
  Scenario Outline: Verify that user "<Username>" initiate a Transfer case for "<Fund>" and other required fields
    ...
    Examples: 
      ...
      | Clientservices002@alterdomus.com | Welcome@123 | Transfer    | Virji Powerware LLC | Automation Testing |     7897654545 | initiated by CSL1 | By CSL1          | \\attachments\\document1.pdf | \\attachments\\document2.pdf | L2 - Initiation |

  @Tansfer_CSL1_initiate_7117 @Reg_7117_2_QA
  Scenario Outline: Verify that user "<Username>" transfer the case to "<otherCSL2>" for FOF Distribution with required fields
    ...
    Examples: 
      ...
      | Clientservices001@alterdomus.com | ClientServices005@alterdomus.com | Welcome@123 | Transfer Assignment | L2 - Initiation |

  @Tansfer_CSL1_initiate_7117 @Reg_7117_3_QA
  Scenario Outline: Verify that user "<Username>" submit case and "<status>" by ClientServices-L2
    ...
    Examples: 
      ...
      | ClientServices005@alterdomus.com | Welcome@123 | case level rejection | By CSL2          | By CSL2          | L1 - AML/KYC Comfort Letter |

  @TansferCOIS_Use_Template @7115_1 @Reg_7117_4_QA
  Scenario Outline: Verify that user "<Username>" initiate a Transfer case for "<Fund>" and other required fields
    ...
    Examples: 
      ...
      | Client001@alterdomus.com | Welcome@123 | Transfer    | Use Template | Automation Testing | \\attachments\\document1.pdf | \\attachments\\document2.pdf | L1 - Transfer Review |
