...
Feature: Verify that CSL1 initiate a case with fund "Kemp Hickinbottom Co." and CSL2 Review and Reslove the chlid case
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_2_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_3_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_4_QA
  Scenario Outline: Verify that user "<Username>" submit case and "<status>" by ClientServices-L2
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_5_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_6_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_7_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_8_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by COISL1
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_9_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by COIS-L2
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
  ...
  #investor
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_10_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by COISL1
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_11_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by COIS-L2
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_12_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_13_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_14_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_15_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_16_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_17_QA
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_18_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by ClientServices-L1
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
  ...
  @Tansfer_Reg_CSL1_Initiate_Done @CSL1_Initiate_19_QA
  Scenario Outline: Verify that user "<Username>" sumit the case and "<status>" by ClientServices-L2
    Given User open the browser and navigate to FundServicesURL
    When the user enters value in "Username" filed with "<Username>"
    When the user enters value in "Password" filed with "<Password>"
