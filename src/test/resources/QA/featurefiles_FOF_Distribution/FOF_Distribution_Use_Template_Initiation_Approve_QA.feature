...
Feature: Verify that CSL1 or CL2 initiate and reslove uing use template for FOF distribution case
  ...
  Scenario Outline: Verify that user "<Username>" initiate case with Use template option from Actions
    ...
    Examples: 
      ...
      | ClientServices002@alterdomus.com | Welcome@123 | FOF Distribution | Use Template | \\attachments\\document1.pdf | Foundation Protyping Inc. |          20000 | Cash       | Asset: Inventory |    20000 | L2 – FoF Distribution Initiation |
