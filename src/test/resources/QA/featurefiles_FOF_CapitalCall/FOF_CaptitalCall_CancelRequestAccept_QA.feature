...
#############################################################################################################
@RegressionFOFCapital_QA @FOFCapitalCall_2QA @RegressionRunQA
Feature: Verify that CS L1 initiates the case and submits cancel request, CS L2 accepts cancel request
  ...
  Scenario Outline: "<Username>" accepts the cancel request
    ...
    Examples: 
      ...
      | Clientservices001@alterdomus.com | Welcome@123 | Testing    | Review Cancel Request Decision | Client Services 001 | invalid    | Resolved-Cancelled |
