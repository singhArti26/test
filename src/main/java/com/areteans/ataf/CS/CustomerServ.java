...
public class CustomerServ extends SeleniumFunc implements CustomerServLoc {
	...
	public void clickAddTaskButton() {
		/*
		 * WebElement AddTaskBtn=driver.findElement(By.xpath(addtaskbtn_xpath)); String
		 * frame1=goToFrame(AddTaskBtn);
		 * //System.out.println("Actual frame where element present is"+ frame1);
		 * waitForElement(AddTaskBtn,2); AddTaskBtn.click();
		 */
	...
	public void clickAddTasksButton() {
		 ...
		 * goToFrame(AddTasksButton); waitForElement(AddTasksButton,2);
		 * AddTasksButton.click(); waitFor(10);
		 */
		try {
	...
	public void clickSubmit() {
		 ...
		 * goToFrame(SubmitButton); waitForElement(SubmitButton,2);
		 * SubmitButton.click(); waitFor(5);
		 */
		try {
	...
	public void selectWB(String value) throws Exception {
		...
		SeleniumFunc.xpath_GenericMethod_selectFromDropdownUsingVisibleTextbyclickingOnDropdown(
				viewqueuefordropdown_xpath, value);
	}
	...
	public void closeBtn() {
		 ...
		 * goToFrame(closeBtnMid); waitForElement(closeBtnMid,2); closeBtnMid.click();
		 * waitFor(2);
		 */
		try {
	...
	public void SubmitBtnMid() {
		/*
		 * WebElement
		 * SubmitButtonMid=driver.findElement(By.xpath(submitbutton_mid_xpath));
		 * goToFrame(SubmitButtonMid); waitForElement(SubmitButtonMid,2);
		 * SubmitButtonMid.click(); waitFor(2);
		 */
		try {
